...
from cli.commands import diff, log, pr, record, verify

app = typer.Typer(
    name="agentctl",
    help=(
        "[bold cyan]agentctl[/bold cyan] — GitHub for Agents.\n\n"
        "Manage an append-only agent action ledger stored in a human-readable "
        "[bold]ledger.md[/bold] file. Record actions, inspect the log, diff "
        "payloads, open correction PRs, and verify chain integrity."
    ),
