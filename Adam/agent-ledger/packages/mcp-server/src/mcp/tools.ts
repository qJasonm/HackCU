...
export const LEDGER_TOOLS: Tool[] = [
  // ---- Registration ----
  {
    name: 'ledger_register',
    description:
      'Register yourself as an agent with the Agent Ledger. You MUST call this before any other ledger tool. ' +
  ...
  // ---- Lease Management ----
  {
    ...
    description:
      'Acquire a lease (lock) on a file BEFORE editing it. This prevents other agents from editing the same file simultaneously. ' +
  ...
  },
  {
    ...
    description:
      'Release a lease (unlock a file) when you are done editing. This allows queued agents to proceed. ' +
  ...
  },
  {
    ...
    description:
      'Send a heartbeat to keep your lease alive during long operations. ' +
  ...
  // ---- Event Logging ----
  {
    ...
    description:
      'Log your INTENT before performing an action. Call this AFTER acquiring a lease but BEFORE editing the file. ' +
  ...
  },
  {
    ...
    description:
      'Log the RESULT of your action after completing it. Call this AFTER editing the file. ' +
  ...
  // ---- Querying ----
  {
    ...
    description:
      'Read recent ledger entries for yourself or another agent. Use this to understand what has been done recently, ' +
  ...
  },
  {
    name: 'ledger_search',
    description:
      'Search the ledger for events matching a text query. Use this to find what was done to a specific file, ' +
  ...
  },
  {
    name: 'ledger_status',
    description:
      'Get a system-wide status overview: number of agents, active leases, pending events, milestones, etc. ' +
  ...
  // ---- Milestones ----
  {
    ...
    description:
      'Declare a project milestone. Use this when a significant piece of work is complete ' +
  ...
  // ---- Sync ----
  {
    ...
    description:
      'Check if there are any pending sync notifications. If a human or external process edited a file you have leased, ' +
  ...
  },
  {
    ...
    description:
      'Acknowledge an external edit notification. After reviewing the changes made by a human or external process, ' +
